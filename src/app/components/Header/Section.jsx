...
const Section = ({ p, h2, p2, button }) => {
    return (
        <div className=" py-10 px-2 flex lg:w-1/2 gap-10  text-white md:px-12 bg-[#333333] md:bg-transparent">
            ...
            <div className='text-start ml-5 '>
                ...
                <button type="button"
                    className="mt-[20px] border rounded-none border-white lowercase h-[50px] w-[300px] text-sm font-medium leading-normal text-white transition duration-150 ease-in-out hover:border-white hover:bg-white  hover:text-black focus:border-white focus:text-black focus:outline-none focus:ring-0 active:bg-white active:border-white active:text-black flex items-center justify-between px-5"
