                ...
                <div className="lg:flex lg:items-center">
                    <div className="flex items-center justify-between">
                        <div className="flex gap-5">
                            ...
                            <ul className="flex text-[#333333] capitalize dark:text-gray-300 items-center gap-4 font-medium">
                                <li>
                                    <Link
                                        href="#"
                                        className="mt-2 transition-colors lg:hidden duration-300 transform lg:mt-0 hover:text-gray-900 text-[12px] xl:text-[13px]  font-semibold dark:hover:text-gray-700"
                                    >
                                        Shop
                                    </Link>
                                </li>
                    ...
                    <div
                        className={`${isOpen ? 'block' : 'hidden'
                            } absolute inset-x-0 z-20 flex-1 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center lg:justify-between mx-10`}
                    >
                        ...
                        <div className="mt-6 lg:flex lg:mt-0 lg:-mx-2 hidden md:block">
